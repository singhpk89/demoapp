package com.example.demo4.views;
...
public class CustomHeaderListView extends ListView implements OnScrollListener, View.OnTouchListener {

    private OnScrollListener mOnScrollListener;

    public static interface CustomHeaderSectionedHeaderAdapter {
    ...
    private CustomHeaderSectionedHeaderAdapter mAdapter;
    ...
    public CustomHeaderListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        super.setOnScrollListener(this);
        super.setOnTouchListener(this);
    }

    public CustomHeaderListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(ListAdapter adapter) {
        mCurrentHeader = null;
        if (adapter instanceof CustomHeaderSectionedHeaderAdapter) {
            mAdapter = (CustomHeaderSectionedHeaderAdapter) adapter;
        } else {
            mAdapter = null;
        }
    ...
    public void setOnItemClickListener(CustomHeaderListView.OnItemClickListener listener) {
